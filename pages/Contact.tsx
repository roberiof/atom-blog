        ...
        <div className='relative py-24 lg:py-32 2xl:py-36'>
            <section className='wrapper-content flex flex-col xl:flex-row items-end gap-16'>
                <div className='flex flex-col gap-4 w-full xl:w-1/2'>
                    ...
                    <p className=' text-lg' data-aos="fade-up"> Bem-vindo ao <span className='cursor-pointer text-primary font-bold hover:underline'>Dev Blog </span>! Somos apaixonados por tecnologia e estamos aqui para compartilhar as <u>últimas novidades, tendências e análises no mundo da tecnologia</u>. Nossa missão é fornecer informações valiosas e insights úteis para ajudar você a acompanhar o <u>ritmo das inovações tecnológicas em constante evolução</u>. </p>
                    ...
                    <ol className='list-disc ml-10 text-lg'>
                        ...
                        <li data-aos="zoom-in"> dev@gmail.com</li>
                    </ol>
